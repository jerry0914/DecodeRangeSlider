...
const char* WIFI_SSID = "ETGtest";
const char* WIFI_PASSWORD = "usi12345";
...
const float LIMITER_BUFFER = 4.0; //mm
const int FORCESHIFT_LIMITER_BUFFER_STEPS = (int)(LIMITER_BUFFER/DISTANCE_PER_STEP);
